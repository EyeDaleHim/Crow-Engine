...
The current menus of Crow Engine are only to replicate Friday Night Funkin' at 0.2.8, they are not meant to fulfill any custom content that mods may desire, you may need to implement your own menus yourself by modifying the source code.
