...
class SemVer
{
    ...
    public static function fromString(versionString:String):SemVer
    {
        ...
        return new SemVer(
            Std.parseInt(SEMVER_REGEX.matched(1)),
            Std.parseInt(SEMVER_REGEX.matched(2)),
            Std.parseInt(SEMVER_REGEX.matched(3)),
            SEMVER_REGEX.matched(4),
            SEMVER_REGEX.matched(5)
        );
    }
