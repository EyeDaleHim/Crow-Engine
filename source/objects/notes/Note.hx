...
class NoteSprite extends FlxSprite
{
	...
	override public function new(?note:Note = null)
	{
		...
		for (animData in Note._noteFile.animationData)
		{
			...
			{
				var fps:Int = Std.int(animData.fps);
                animation.addByIndices(animData.name, animData.prefix, animData.indices, "", fps, animData.looped);
                sustain.animation.addByIndices(animData.name, animData.prefix, animData.indices, "", fps, animData.looped);
                sustainEnd.animation.addByIndices(animData.name, animData.prefix, animData.indices, "", fps, animData.looped);
			}
			else
			{
				var fps:Int = Std.int(animData.fps);
                animation.addByPrefix(animData.name, animData.prefix, fps, animData.looped);
                sustain.animation.addByPrefix(animData.name, animData.prefix, fps, animData.looped);
                sustainEnd.animation.addByPrefix(animData.name, animData.prefix, fps, animData.looped);
			}
